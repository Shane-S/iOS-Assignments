 ...
 * @param attributes     An array of shader attribute structs ({GLuint attributeIndex, const char* attributeName})
 ...
 * @discussion Returns an int that represents the texture
